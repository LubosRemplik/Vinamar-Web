...
// Terms are spaced with exact 7-night gaps. Thanks to turnover days (a term's
// check-in day is selectable as your check-out), each gap is a clean bookable week:
// e.g. 13.→20. 7. and 27. 7.→3. 8.
const SUMMER_2026 = [
